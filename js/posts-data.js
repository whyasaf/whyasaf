    ...
    tr: {
      ...
      content: `
        ...
        <p>
          ...
          Gereksiz her karakter, kullanıcının taşımak zorunda olduğu bir yüktür ve ASI bu yükü bizim adımıza tamamen yok etmeye hazırlanıyor.
        </p>
        ...
        <p>
          Bu niyetin uygulamadan ayrılması, karanlık modun mümkün olmasını sağlayan şeydir; ancak aynı zamanda sistemin "neye dönüşeceğine" karar veren mekanizmadır. 
  ...
  "than-code": {
    ...
    tr: {
      ...
      content: `
        ...
        <p>
          Bir havaalanı nasıl çalışır? Binlerce insanı, veriyi ve süreci kim yönetir? Dışarıdan bakıldığında kaos gibi görünen bu yapıların arkasında kusursuz bir düzen yatar. 
    ...
    en: {
      ...
      content: `
        ...
        <p>
          How does an airport work? Who manages thousands of people, data streams, and processes? 
